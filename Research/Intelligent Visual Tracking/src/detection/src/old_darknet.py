...
#     rospy.Subscriber("/omnicam/image_raw/compressed", CompressedImage, imageCallback)
...
def main():
    ...
    net = load_net(b"/home/nvidia/darknet/cfg/yolov2.cfg", b"/home/nvidia/darknet/yolov2.weights", 0)
