function bool_feas = check_feasible_new_combi(x)
global t t_middle t_future R comb gamma target_num host_class ptz_fov wt ws f D ptz_ws ptz_resol ptz_f;
