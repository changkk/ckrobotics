...
namespace gazebo
{
  class GAZEBO_VISIBLE GimbalController : public ModelPlugin
  {
    /// \brief Constructor
    ...
    /// \brief yaw camera
    private: physics::LinkPtr yawLink;

    /// \brief camera roll link
    private: physics::LinkPtr rollLink;

    /// \brief camera pitch link
    private: physics::LinkPtr pitchLink;
