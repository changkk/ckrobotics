...
lib = CDLL("/home/usl/darknet/libdarknet.so", RTLD_GLOBAL)
...
def main():
    ...
    net = load_net(b"/home/usl/darknet/cfg/yolov2.cfg", b"/home/usl/darknet/yolov2.weights", 0)
    meta = load_meta(b"/home/usl/darknet/cfg/coco.data")
